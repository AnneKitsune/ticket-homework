...
public class Repository {
    ...
    private static var sharedRepository: Repository = {
        ...
        repository.tickets.append(Ticket(id: 1, title: "Create a new language", content: "Create a new language for the only purpose to force programmers to change their coding habit. We will probably be able to force people to pay for this", createdAt: "2017-01-01", closedBy: nil, openedBy: repository.users[2].id, closedAt: nil, priority: "Critique", forUser: repository.users[1].id))
        repository.tickets.append(Ticket(id: 2, title: "Upgrade our last language with useful feature", content: "User are requesting better and more content for their new forced favorite language", createdAt: "2018-01-01", closedBy: nil, openedBy: repository.users[2].id, closedAt: nil, priority: "Important", forUser: repository.users[3].id))
